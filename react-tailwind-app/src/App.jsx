    ...
    <div className="min-h-screen flex flex-col bg-[var(--color-neutral-50)] pl-8">
      ...
      <header className="bg-[var(--color-web-green-600)] text-white py-8 shadow-md">
        <div className="container mx-auto px-4 flex flex-col items-center">
          ...
          <button onClick={() => window.location.href = '/login'} className="mt-4 inline-block bg-white text-[var(--color-web-green-700)] font-semibold px-6 py-2 rounded-md shadow hover:bg-[var(--color-web-green-100)] transition">เข้าสู่ระบบ</button>
        </div>
      </header>
