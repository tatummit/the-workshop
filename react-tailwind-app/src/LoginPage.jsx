  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-neutral-50)]">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow max-w-md w-full">
        ...
        <button type="button" onClick={() => window.location.href = '/'} className="mb-6 bg-[var(--color-neutral-200)] text-[var(--color-web-green-700)] px-4 py-2 rounded-md font-semibold hover:bg-[var(--color-neutral-300)] transition w-full">ย้อนกลับหน้าแรก</button>
        <div className="mb-4">
